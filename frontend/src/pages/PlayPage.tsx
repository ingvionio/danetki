  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-zinc-950 px-4 py-12">
      ...
      <div className="relative z-10 flex w-full max-w-xl flex-col items-center text-center">
        ...
        >
          {puzzle && (
            <div className="mb-8 rounded-2xl border border-white/10 bg-zinc-900/70 p-8 text-left shadow-2xl shadow-indigo-950/40 backdrop-blur transition-all duration-500">
